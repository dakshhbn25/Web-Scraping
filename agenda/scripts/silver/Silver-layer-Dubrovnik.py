...
BRONZE_PATH = "agenda/data/bronze/dubrovnik.json"
SILVER_PATH = "agenda/data/silver/dubrovnik_agenda.json"
EVENT_NAME = "Dubrovnik"

TRACKS_TO_KEEP = {"MAIN STAGE", "INNOVATION STAGE"}
...
def main():
    ...
    print(f"{len(sessions)} sessions (Main Stage + Innovation Stage, both days)")
