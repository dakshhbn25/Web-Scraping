...
BRONZE_PATH = "agenda/data/bronze/medical_agenda.json"
SILVER_PATH = "agenda/data/silver/medical_agenda.json"
EVENT_NAME = "Medical"

TRACKS_TO_KEEP = {"MAIN STAGE", "AI STAGE", "Learn Stage"}
...
def main():
    ...
    print(f"{len(sessions)} sessions (Main Stage + AI Stage + Learn Stage)")
