...
BRONZE_PATH = "sponsors/data/bronze/dubrovnik.json"
DESCRIPTIONS_PATH = "sponsors/data/bronze/dubrovnik_descriptions.json"
SILVER_PATH = "sponsors/data/silver/dubrovnik.json"
