...
BRONZE_PATH = "sponsors/data/bronze/medical.json"
DESCRIPTIONS_PATH = "sponsors/data/bronze/medical_descriptions.json"
SILVER_PATH = "sponsors/data/silver/medical.json"
EVENT_NAME = "Medical"
